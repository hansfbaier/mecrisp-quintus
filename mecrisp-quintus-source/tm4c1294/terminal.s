...
# -----------------------------------------------------------------------------
  ...
  li x15, 0x7FFF       # Alle GPIO-Ports aktivieren
  li x14, RCGCPIO
  sw x15, 0(x14)
  ...
  li x15, 0x11         # In diesem Chip ist die serielle Schnittstelle nicht standardmäßig als Sonderfunktion aktiviert
  li x14, GPIO_PORTA_AHB_PCTL_R
  sw x15, 0(x14)

  li x15, 3            # PA0 und PA1 auf UART-Sonderfunktion schalten
  li x14, GPIO_PORTA_AHB_AFSEL_R
  sw x15, 0(x14)

  li x15, 3            # PA0 und PA1 als digitale Leitungen aktivieren
  li x14, GPIO_PORTA_AHB_DEN_R
  sw x15, 0(x14)
